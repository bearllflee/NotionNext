...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的Golang发者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bearllflee.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Golang, 技术分享', // 网站关键词 英文逗号隔开
